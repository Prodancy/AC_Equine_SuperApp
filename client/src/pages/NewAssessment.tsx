...
export default function NewAssessment() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#0a0f1d] overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto p-4 md:p-10 space-y-12 pb-32">
          <section className="space-y-6">
            <div className="flex justify-between items-end">
              <Label className="text-[10px] uppercase tracking-[0.3em] text-primary font-black">Digital Thermography (Live Stream)</Label>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <section className="space-y-4">
              <Label className="text-[10px] uppercase tracking-[0.3em] text-primary font-black">Clinical Category</Label>
            ...
            <section className="space-y-4">
              <Label className="text-[10px] uppercase tracking-[0.3em] text-primary font-black">Proposed Modalities</Label>
          ...
          <section className="space-y-4 pb-10">
            <Label className="text-[10px] uppercase tracking-[0.3em] text-primary font-black">Clinical Notes</Label>
      ...
      <footer className="fixed bottom-0 left-0 right-0 p-6 border-t border-white/5 bg-[#111827]/80 backdrop-blur-xl shrink-0 z-50">
