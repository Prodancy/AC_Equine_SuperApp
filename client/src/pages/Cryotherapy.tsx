      ...
      <div className="flex flex-col bg-card/30 backdrop-blur-md sticky top-0 z-50 border-b border-white/5 -mx-4 md:-mx-8 mb-6">
        ...
        <div className="flex px-4 md:px-8">
          <button 
            ...
            className="flex-1 py-3 tracking-[0.2em] uppercase transition-all relative text-[14px] text-[#3D63DD] font-extrabold"
          >
            Manual Mode
            {activeTab === "controls" && (
          ...
          <button 
            ...
            className="flex-1 py-3 tracking-[0.2em] uppercase transition-all relative text-[14px] text-[#A9B3CE] hover:text-[#A9B3CE]/80 font-extrabold"
          >
            Protocol Mode
            {activeTab === "thermal" && (
              <motion.div layoutId="activeTab" className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#3D63DD]" />
