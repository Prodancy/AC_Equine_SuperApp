...
const protocols = [
  ...
  { id: "p25", bodyPart: "neck", name: "Neural Calm", duration: 18, intensity: 45, temp: -90 },
  { id: "p26", bodyPart: "neck", name: "Flex Boost", duration: 10, intensity: 65, temp: -115 },
  // Back Left
  ...
  { id: "p27", bodyPart: "back-left", name: "Spine Care", duration: 12, intensity: 70, temp: -125 },
  { id: "p28", bodyPart: "back-left", name: "Warm Up", duration: 5, intensity: 40, temp: -80 },
  // Front Leg Left
  ...
  { id: "p29", bodyPart: "leg-front-left", name: "Tendon Relief", duration: 14, intensity: 80, temp: -140 },
  { id: "p30", bodyPart: "leg-front-left", name: "Joint Support", duration: 11, intensity: 65, temp: -120 },
  // Back Right
  ...
  { id: "p31", bodyPart: "back-right", name: "Core Strength", duration: 20, intensity: 75, temp: -130 },
  { id: "p32", bodyPart: "back-right", name: "Recovery Max", duration: 15, intensity: 85, temp: -150 },
  // Front Leg Right
  ...
  { id: "p33", bodyPart: "leg-front-right", name: "Shin Relief", duration: 9, intensity: 60, temp: -110 },
  { id: "p34", bodyPart: "leg-front-right", name: "Circulation", duration: 13, intensity: 70, temp: -125 },
  // Hoof Front Left
  ...
  { id: "p35", bodyPart: "hoof-front-left", name: "Sole Comfort", duration: 8, intensity: 50, temp: -100 },
  { id: "p36", bodyPart: "hoof-front-left", name: "Heel Care", duration: 11, intensity: 65, temp: -120 },
];
                      ...
                      {filteredProtocols.map((p) => (
                        ...
                        >
                          <div className={cn(
                            ...
                            <p className="uppercase tracking-tight text-[11px] font-bold text-white">
                              {p.name}
                            </p>
                          </div>
                        </div>
