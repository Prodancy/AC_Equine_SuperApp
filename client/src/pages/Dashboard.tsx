          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              >
                ...
                <span className="md:text-xs tracking-[0.1em] text-[15px] font-semibold">Schedule</span>
              </Button>
              ...
              <Link href="/horses" className="w-full">
                ...
                >
                  ...
                  <span className="md:text-xs tracking-[0.1em] text-[15px] font-semibold">Patients</span>
                </Button>
              </Link>
              ...
              <Link href="/billing" className="w-full">
                ...
                >
                  ...
                  <span className="md:text-xs tracking-[0.1em] text-[15px] font-semibold">Billing</span>
                </Button>
              </Link>
            </div>
          </div>
