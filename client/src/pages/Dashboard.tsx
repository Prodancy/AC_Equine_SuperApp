          ...
          <Dialog open={isScheduleOpen} onOpenChange={setIsScheduleOpen}>
            ...
            <DialogContent className="sm:max-w-md bg-[#0a0f1d] border-white/10">
                  ...
                  {isAddingNewHorse ? (
                    <div className="space-y-2 animate-in fade-in slide-in-from-top-1 duration-200">
                      <input 
                        ...
                        className="w-full h-11 bg-white/5 border border-white/10 rounded-xl px-4 text-sm focus:outline-none focus:ring-1 focus:ring-primary/50 text-white"
                        value={newHorseName}
                    ...
                    <div className="relative group">
                      <select 
                        className="w-full h-11 bg-white/5 border border-white/10 rounded-xl px-4 text-sm focus:outline-none focus:ring-1 focus:ring-primary/50 text-white appearance-none cursor-pointer"
                        value={selectedHorse}
                  ...
                  <div className="grid grid-cols-7 gap-2">
                    {[...Array(7)].map((_, i) => (
                      <div key={i} className={cn(
                        "aspect-square rounded-lg border border-white/5 flex flex-col items-center justify-center text-[10px] font-bold cursor-pointer transition-all hover:border-primary/50",
                        i === 1 ? "bg-primary text-white shadow-lg shadow-primary/20" : "bg-white/5 text-gray-500 hover:bg-white/10"
                      )}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {['09:00', '10:30', '14:00', '15:30', '17:00'].map(time => (
                      <Button key={time} variant="outline" className="h-10 text-xs border-white/5 bg-white/5 hover:border-primary/50 hover:bg-primary/5 transition-all">{time}</Button>
                    ))}
                  </div>
                </div>
              </div>
              <DialogFooter className="pt-2">
                <Button 
                  className="w-full bg-primary text-white font-bold tracking-widest uppercase h-12 shadow-lg shadow-primary/20" 
                  onClick={() => {
